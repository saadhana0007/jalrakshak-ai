      ...
      <Card className="mt-6">
        <CardContent className="p-5">
          ...
          <div className="overflow-x-auto">
              ...
              <tbody>
                {filtered.slice(0, 30).map((f) => (
                  <tr key={f.id} className="border-b border-slate-50 hover:bg-slate-50">
                    ...
                    <td className="py-2.5 text-slate-600">{f.farmerName}</td>
                    <td className="py-2.5 text-slate-500">{f.district}</td>
                    <td className="py-2.5 text-slate-500">{f.cropType}</td>
                    <td className="py-2.5 text-slate-500">{f.areaAcres} ac</td>
            ...
            {filtered.length === 0 && <p className="py-8 text-center text-sm text-slate-400">No farmers match these filters.</p>}
          </div>
        </CardContent>
      </Card>
    </DashboardShell>
